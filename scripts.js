...
// Counter Logic
  ...
  if (time >= 2400){
    ...
    var element = document.getElementById("cooldown");
        element.classList.add("finished");
    var element = document.getElementById("cooldown3");
        element.classList.add("finished");
  }
...
// Section Completion
  ...
  if (time === 480){
    ...
    if (time === 1680){
      var element = document.getElementById("interval10");
          element.classList.add("finished");
      var element = document.getElementById("interval11");
          element.classList.add("inprogress");
      var audio = new Audio('tone.wav');
      audio.play();
    }
    ...
    if (time === 1800){
      var element = document.getElementById("interval11");
          element.classList.add("finished");
      var element = document.getElementById("interval12");
          element.classList.add("inprogress");
      var audio = new Audio('tone.wav');
      audio.play();
    }
    ...
    if (time === 1920){
      var element = document.getElementById("interval12");
          element.classList.add("finished");
      var element = document.getElementById("interval13");
          element.classList.add("inprogress");
      var audio = new Audio('tone.wav');
      audio.play();
    }
    ...
    if (time === 2160){
      var element = document.getElementById("cooldown1");
          element.classList.add("finished");
      var element = document.getElementById("cooldown2");
          element.classList.add("inprogress");
      var audio = new Audio('tone.wav');
      audio.play();
    }
